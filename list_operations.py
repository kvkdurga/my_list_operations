...
def middle(input_list):
    ...
    """
    except_first2_last2 = input_list[2:-2]
    return except_first2_last2
...
def inner_four(input_list):
    ...
    """
    third_to_sixth = input_list[2:6]

    return third_to_sixth
...
def inner_four_end(input_list):
    ...
    """
    four_from_middle = input_list[-6:-2]

    return four_from_middle
